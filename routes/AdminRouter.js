...
router.post("/addcategory", (req, res) => {
    ...
    AdminController.addCategory(catname, caticonname).then((result) => {
        ...
        res.render("addcategory", { "sunm": req.session.sunm, "output": "Category Added Succefully." });
    }).catch((err) => {
...
router.post("/addsubcategory", (req, res) => {
    ...
    AdminController.addSubCategory(catname, subcatname, subcaticonname).then((result) => {
        ...
        fileobj.mv(uploadpath);
        res.render("addsubcategory", { "sunm": req.session.sunm, "output": "Sub category Added Succefully.", "clist": clist });
    }).catch((err) => {
